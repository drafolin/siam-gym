    ...
    <main className="page-cours">
      ...
      <section className="prices">
        ...
        <div className="subsection subs">
          <section>
            ...
            <div className="w1">
              ...
              <ul className="my-4">
                <li>
                  <strong>Dual</strong> inclus deux disciplines, sauf Muay Thaï.
                </li>
                <li>
                  <strong>Dual thaï</strong> inclus le Muay Thaï et une autre
                  discipline.
                </li>
                <li>
                  <strong>All-inclusive</strong> inclus toutes les disciplines
                  du club.
                </li>
              </ul>
            </div>
        ...
        <div className="subsection unique-courses">
          ...
          <p className="py-4">
            Vous pouvez participer à un seul cours pour le prix de 10.- par
            cours.
          </p>
        </div>
        <div className="subsection multicourse">
          ...
          <p className="py-4">
            ...
            programme de fidélité. Une réduction de CHF 1.- par cours vous est
            offerte pour chaque série de 10 cours.
          </p>
          <p className="py-4">Vous payez donc ainsi:</p>
          <ul className="py-4">
